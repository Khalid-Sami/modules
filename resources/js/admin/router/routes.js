export default [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "createCustomer",
                component: () => import("@/views/components/customer/Create.vue")
            },
            {
                path: '/users',
                name: 'users',
                ...
                children: [
                    {
                        path: '/',
                        name: 'users.all',
                        component: () => import('@/views/components/users/list.vue')
                    },
                    {
                        path: 'create',
                        name: 'users.create',
                        component: () => import('@/views/components/users/create.vue')
                    }
                ]
            },
            {
