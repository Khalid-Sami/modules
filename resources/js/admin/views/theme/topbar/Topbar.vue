        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            ...
            >
                <div class="kt-header__topbar-user">
                    ...
                    <span class="kt-header__topbar-username kt-hidden-mobile">Mousab</span>
                    <img
                        class="kt-hidden"
                        alt="Pic"
        ...
        methods: {
            onLanguageChanged() {
                this.languageFlag = this.languages.find(val => {
                    var isAr = val.lang === "ar";

                    this.$cookie.set('locale',  val.lang, { expires: 1 });
                    if (isAr) {
                        document.querySelector("body").setAttribute("style", "direction:rtl");

                        return val.lang === i18nService.getActiveLanguage();
                    }
                    else {
                        document.querySelector("body").setAttribute("style", "direction:ltr");
